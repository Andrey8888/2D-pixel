...
public class PickupMeleeWeapons : Actor
{
    ...
    public int MeleeAttackCriticalDamage = 0;
    ...
    new void Update()
    {
        ...
        if (dist < 50 && OnMouse)
        {
            ...
            {
                if (player.PickUpMeleeWeapon(Type.ToString(), MeleeAttackMinDamage * level,MeleeAttackMaxDamage * level, 
                MeleeAttackCooldownTime, MeleeAttackCriticalDamage, CriticalDamageMultiply, ChanceCriticalDamage,
