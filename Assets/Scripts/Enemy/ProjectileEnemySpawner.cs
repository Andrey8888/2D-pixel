...
public class ProjectileEnemySpawner : MonoBehaviour
{
    ...
    public void InstantiateProjectile()
    {
        ...
        p.transform.localScale = new Vector3((float)DirectionShoot * parentXScale * p.transform.localScale.x, p.transform.localScale.y, p.transform.localScale.z);
